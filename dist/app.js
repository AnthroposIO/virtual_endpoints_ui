...
Component that was made reactive: `, type);
  ...
  function getAttrsProxy(instance) {
    return instance.attrsProxy || (instance.attrsProxy = new Proxy(instance.attrs, !!(process.env.NODE_ENV !== "production") ? {
      get(target, key) {
        markAttrsAccessed();
...
- For vite: pass it via @vitejs/plugin-vue options. See https://github.com/vitejs/vite-plugin-vue/tree/main/packages/plugin-vue#example-for-passing-options-to-vuecompiler-sfc`;
  ...
  var header_default = {
    ...
    template: `
      <header>
        <div class="px-3 py-4 bg-light text-white">
          <div class="container">
            <div class="d-flex flex-wrap align-items-center justify-content-center">
              <img src="anthropos.svg" alt="" style="width:200px;">
            </div>
          </div>
        </div>
      </header>
  ...
  var home_default = {
    data() {
      return {username: "", password: "", error: false, checking: false};
    },
    methods: {},
    template: `
  ...
  // src/app.js
  createApp(main_default).mount("#app");
})();
